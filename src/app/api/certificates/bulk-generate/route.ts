...
function getAchievementText(place: number): string {
  switch (place) {
    case 1:
      return 'занявшему I место в I Межвузовской студенческой олимпиаде по акушерству и гинекологии им. профессора В.В. Горячева';
    case 2:
      return 'занявшему II место в I Межвузовской студенческой олимпиаде по акушерству и гинекологии им. профессора В.В. Горячева';
    case 3:
      return 'занявшему III место в I Межвузовской студенческой олимпиаде по акушерству и гинекологии им. профессора В.В. Горячева';
    default:
      return 'за участие в I Межвузовской студенческой олимпиаде по акушерству и гинекологии им. профессора В.В. Горячева';
  }
}
