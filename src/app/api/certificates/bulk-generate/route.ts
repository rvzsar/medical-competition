...
function getAchievementText(place: number): string {
  switch (place) {
    case 1:
      return 'за I место в I Межвузовской студенческой олимпиаде по акушерству и гинекологии им. профессора В.В. Горячева';
    case 2:
      return 'за II место в I Межвузовской студенческой олимпиаде по акушерству и гинекологии им. профессора В.В. Горячева';
    case 3:
      return 'за III место в I Межвузовской студенческой олимпиаде по акушерству и гинекологии им. профессора В.В. Горячева';
    default:
